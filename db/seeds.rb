coaches = Coach.create!([{name: 'Jonas', email: 'jonas.preisler@gmail.com', password: 'testtest', password_confirmation: 'testtest'}, {name: 'Jonas', email: 'hey@gmail.com', password: 'testtest', password_confirmation: 'testtest'}])
