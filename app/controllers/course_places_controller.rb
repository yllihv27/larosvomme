class CoursePlacesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @course_place.save
        format.html { redirect_to @course_place, notice: 'Course place was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @course_place.update(course_place_params)
        format.html { redirect_to @course_place, notice: 'Course place was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to course_places_url, notice: 'Course place was successfully destroyed.' }
  ...
  private
    ...
    def course_place_params
      params.require(:course_place).permit(:name, :address, :phone, :description)
    end
end
